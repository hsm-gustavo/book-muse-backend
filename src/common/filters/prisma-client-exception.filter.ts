/**
 * Using nestjs-prisma code for this filter: https://github.com/notiz-dev/nestjs-prisma/blob/main/lib/prisma-client-exception.filter.ts
 *
 * Installing the package warned me about unmet peer dependency,
 * so to avoid further issues, I decided to take the
 * code of the only thing that I wanted to use from the package
 *
 */
...
export class PrismaClientExceptionFilter extends BaseExceptionFilter {
  ...
  private defaultStatusCode(
    ...
    return this.defaultMapping[
      exception.code as keyof typeof this.defaultMapping
    ];
  }
